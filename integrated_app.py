...
@app.callback(
    ...
    [State("file_name","children"),State('contribution_table', 'data'),State('summary_table','data'),
     State('dfa_table','data'),State('kpi_name','value')]
)
def update_decomp_data(n_clicks,file_name,contri_table_data,summary_dict,dfa_dict,kpi_name):
    ...
    if n_clicks is None or file_name is None:
        ...
        decomp_absolute_df,decomp_absolute_cols,decomp_percentage_df,decomp_percentage_cols,fig=prepare_and_compute_decomp_data(file_name,contri_table_data,summary_dict,dfa_dict,kpi_name)
...
def prepare_and_compute_decomp_data(file_name,contri_table_data,summary_dict,dfa_dict,kpi_name):
